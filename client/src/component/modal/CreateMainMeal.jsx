...
const CreateMainMeal = ({show, onHide}) => {
    ...
    const addMainMeal = async () => {
        const form = new FormData()
        form.append('name', `${name}`)
        form.append('price', `${price}`)
        form.append('photo', `${photo}`)
        form.append('category', `Основные блюда`)
    ...
    return (
        ...
        >
            ...
            <Modal.Footer>
                ...
                <Button variant='outline-success' onClick={addMainMeal}>Добавить</Button>
            </Modal.Footer>
        </Modal>
    );
};

export default CreateMainMeal;